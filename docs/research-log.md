...
- Key deadlines: 12.08.2026 EPR registration / DoC / authorised representative / packaging minimisation principle (Art. 24) / PFAS limits for food packaging; 12.02.2027 member-state penalty regimes + national producer registers set up; 12.08.2028 harmonised labelling; 01.01.2030 recyclability grades (A/B/C), recycled-content minimums, reuse targets, **50% empty-space ratio cap** (Art. 24; grouped/transport/e-commerce). Empty-space cap is 50%, NOT 40% (40% was the Commission proposal), and applies from 01.01.2030 — or 3 years after the empty-space calculation implementing act (Commission to adopt by 12.02.2028), whichever is later — NOT from 12.08.2026. Corrected 2026-08-17; verify exact Art. 24 wording against EUR-Lex consolidated text.
...
- E-commerce: shipping cartons, mailers, poly bags, void fill, bubble wrap, inserts ALL in scope; no B2C dispatch carve-out; **50% max empty space from 2030** (Art. 24), calculated on product dimensional volume vs inner carton volume (secondary sources: shippypro.com, clarity.eco, fieldfisher.com — 50% confirmed; 40% was an earlier proposal figure).
