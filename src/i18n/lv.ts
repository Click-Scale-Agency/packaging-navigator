...
export const lv = {
  ...
  producers: {
    ...
    wizard: {
      ...
      copySummary: "Kopēt kopsavilkumu",
      copied: "Nokopēts!",
      downloadTemplate: "Lejupielādēt tehnisko datu veidlapu",
    ...
    template: {
      ...
      title: "Iepakojuma tehnisko datu veidlapa klientam",
      lead: "Tehnisko datu nodošanas veidlapa PPWR atbilstības dokumentācijas un EPR aprēķinu datu apkopošanai — aizpildi katrai iepakojuma konfigurācijai un dod klientam. Pati par sevi tā nav ES atbilstības deklarācija. Lejupielādē un pielāgo (MIT, brīvi izmantojama).",
      download: "Lejupielādēt Markdown (.md)",
      downloadDocx: "Lejupielādēt Word (.docx)",
      contentsTitle: "Veidlapas saturs",
      contents: [
        "Dokumenta un iepakojuma identifikācija: versijas, SKU, konfigurācijas, mērķa valstis",
        "Puses un lomas: PPWR izgatavotājs, piegādātājs, importētājs, izplatītājs un EPR ražotājs — ar mikrouzņēmumu izņēmumu",
        "Iepakojuma sastāvs pa komponentēm un līmeņiem ar svariem, pārstrādāto saturu un pierādījumu dokumentiem",
        "Pārstrādājamība, minimizācija un tukšā telpa — ar piemērošanas datumiem un atrunām",
        "PFAS un smagie metāli, ES atbilstības deklarācijas nošķīrums, EPR aprēķinu palīgtabula",
      ],
    },
    faq: {
    ...
    promo: {
      ...
      bullet3: "Iepakojuma tehnisko datu veidlapa klientam lejupielādei",
    },
    disclaimer:
